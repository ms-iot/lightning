        ...
        namespace Lightning {
            namespace Providers {
                ...
                private:
                    ...
                    inline USHORT flipShort(USHORT dataOut)
                    {
                        return (dataOut << 8) | ((dataOut >> 8) & 0xFF);
                    }

                    inline ULONG flipLong(ULONG dataOut)
                    {
                        return (dataOut << 24) | ((dataOut << 8) & 0xFF0000) | ((dataOut >> 8) & 0xFF00) | ((dataOut >> 24) & 0xFF);
                    }
